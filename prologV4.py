...
def open_log():
    global logbook
    #
    logbook = askopenfilename(initialdir='/home/kelly/',
...
def import_csv_data():
    ...
    name = askopenfilename(initialdir='/home/kelly/',
...
tick()
#
m1 = PanedWindow(relief = 'sunken', orient='horizontal', height = 600, width = 100)
...
m1.add(qso_data)
#
usamap = Label(m1, text ='usamap', relief ='sunken', height = 450, width = 10)
m1.add(usamap)

worldmap = Label(m1, text = 'worldmap', relief = 'sunken', height =450, width =10)
m1.add(worldmap)

bandplan = Label(m1, text = 'bandplan', relief = 'sunken', height =450, width =10)
m1.add(bandplan)
#
photo1 = PhotoImage(file="/home/kelly/python_code/wasmap.gif")
w1 = Label(usamap, height =765, width =1004, image=photo1)

photo2 = PhotoImage(file="/home/kelly/python_code/prefix.gif")
w2 = Label(worldmap, height =765, width =1004, image=photo2)
#
photo3 = PhotoImage(file="/home/kelly/python_code/band_plan_color.gif")
w3 = Label(bandplan, height =765, width =1004, image=photo3)
#
w1.photo = photo1
w2.photo = photo2
w3.photo = photo3
...
Label(qso_data, text ='Frequency', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=2, column =0)
...
Label(qso_data, text='Name', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=5, column =0)
#Label(qso_data, text='Last Name', font = 'Piboto 14').grid(row=9)
Label(qso_data, text = 'City', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=6, column =0)
