...
#filemenu.add_command(label='New Log', command=create_log) # here do a button function
...
#
top = Label(m1, text='', relief = 'sunken', height = 100, width = 10)
m1.add(top)
#
logdata = Text(m1, font=('Piboto', 14, 'normal'), bg='light grey', height = 5, width =10)
m1.add(logdata)
logdata.config(state='disabled')
#
...
#e6.grid(row=9, column =1) Last name not required
