...
class StatusBar(Frame):
    ...
    def __init__(self, master):
        ...
        self.label = Label(self, bd=1, relief=SUNKEN, anchor=W, font = 'Piboto 16')
...
if __name__ == '__main__':
   ...
   root = Tk()
root.title('Prolog Version 3.0 - KD5AJ')
...
#
qso_data = Label(m1, text='', relief = 'sunken', height = 500, width = 50)
m1.add(qso_data)
#
#notesarea = Text(m1, font=('Piboto', 16, 'normal'), bg='light grey', fg ='dark blue', selectbackground ='dark blue', selectforeground = 'yellow', height = 5, width =95)
#m1.add(notesarea)
#define Text window for notes.
#
logdata = Text(m1, font=('Piboto', 14, 'normal'), bg='light grey', height = 5, width =50)
m1.add(logdata)
#
bandplan = Label(m1, text ='bandplan', relief ='sunken', height = 5, width = 10)
m1.add(bandplan)
#
photo = PhotoImage(file="/home/pi/python_code/band_plan.png")
w = Label(bandplan, height =800, width =1040, image=photo)
w.photo = photo
bands_photo = photo
w.pack()
#
...
start_qso.grid(row= 17, column = 0)
end_qso = Button(qso_data, textvariable = endq, command = get_time_end, font = 'Piboto 16')
end_qso.grid(row= 17, column = 1)
date_qso = Label(qso_data, textvariable = qso_date_utc, font = 'Piboto 16')
date_qso.grid(row= 2, column=1)
#
save_qso = Button(qso_data, text = 'Save QSO', command = save_qso, font = 'Piboto 16')
save_qso.grid(row= 18, column = 1)
save_qso.config(state = 'disabled')
#
# Provide Labels for entry fields
Label(qso_data, text= 'Station', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=4)
Label(qso_data, text ='Frequency', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=5)
Label(qso_data, text = 'Report Sent', font = 'Piboto 14', anchor= 'e', width = 12).grid(row =6)
Label(qso_data, text = 'Report Recvd', font = 'Piboto 14', anchor= 'e', width = 12).grid(row =7)
Label(qso_data, text='Name', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=8)
Label(qso_data, text = 'City', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=10)
Label(qso_data, text = 'State', font = 'Piboto 14').grid(row=12, column =0)
Label(qso_data, text ='Power ', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=13, column = 0)
Label(qso_data, text = 'Mode ', font = 'Piboto 14', anchor= 'e', width = 12).grid(row=14, column = 0)
#
...
# There is no e6 field; it WAS last name... removed.
e7.grid(row=10, column =1)# City
